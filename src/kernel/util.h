...
void
list_add_to_behind(struct List* entry, struct List* new);
void
list_add_to_behind(struct List* entry, struct List* new) ////add to entry behind
{
  new->next = entry->next;
  new->prev = entry;
  new->next->prev = new;
...
void
list_add_to_before(struct List* entry, struct List* new);
void
list_add_to_before(struct List* entry, struct List* new) ////add to entry behind
{
  new->next = entry;
  entry->prev->next = new;
  new->prev = entry->prev;
...
*/
void*
memcpy(void* From, void* To, long Num);
void*
memcpy(void* From, void* To, long Num)
{
  int d0, d1, d2;
...
*/
int
memcmp(void* FirstPart, void* SecondPart, long Count);
int
memcmp(void* FirstPart, void* SecondPart, long Count)
{
  register int __res;
...
*/
void*
memset(void* Address, unsigned char C, long Count);
void*
memset(void* Address, unsigned char C, long Count)
{
  int d0, d1;
...
*/
char*
strncpy(char* Dest, char* Src, long Count);
char*
strncpy(char* Dest, char* Src, long Count)
{
  __asm__ __volatile__("cld	\n\t"
...
*/
int
strcmp(char* FirstPart, char* SecondPart);
int
strcmp(char* FirstPart, char* SecondPart)
{
  register int __res;
...
*/
int
strncmp(char* FirstPart, char* SecondPart, long Count);
int
strncmp(char* FirstPart, char* SecondPart, long Count)
{
  register int __res;
...
*/
void
io_out8(unsigned short port, unsigned char value);
void
io_out8(unsigned short port, unsigned char value)
{
