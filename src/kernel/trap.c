...
void
do_divide_error(unsigned long rsp, unsigned long error_code);
void
do_divide_error(unsigned long rsp, unsigned long error_code)
{
...
void
do_debug(unsigned long rsp, unsigned long error_code);
void
do_debug(unsigned long rsp, unsigned long error_code)
{
...
void
do_nmi(unsigned long rsp, unsigned long error_code);
void
do_nmi(unsigned long rsp, unsigned long error_code)
{
...
void
do_int3(unsigned long rsp, unsigned long error_code);
void
do_int3(unsigned long rsp, unsigned long error_code)
{
...
void
do_overflow(unsigned long rsp, unsigned long error_code);
void
do_overflow(unsigned long rsp, unsigned long error_code)
{
...
void
do_bounds(unsigned long rsp, unsigned long error_code);
void
do_bounds(unsigned long rsp, unsigned long error_code)
{
...
void
do_undefined_opcode(unsigned long rsp, unsigned long error_code);
void
do_undefined_opcode(unsigned long rsp, unsigned long error_code)
{
...
void
do_dev_not_available(unsigned long rsp, unsigned long error_code);
void
do_dev_not_available(unsigned long rsp, unsigned long error_code)
{
...
void
do_double_fault(unsigned long rsp, unsigned long error_code);
void
do_double_fault(unsigned long rsp, unsigned long error_code)
{
...
void
do_coprocessor_segment_overrun(unsigned long rsp, unsigned long error_code);
void
do_coprocessor_segment_overrun(unsigned long rsp, unsigned long error_code)
{
...
void
do_invalid_TSS(unsigned long rsp, unsigned long error_code);
void
do_invalid_TSS(unsigned long rsp, unsigned long error_code)
{
...
void
do_segment_not_present(unsigned long rsp, unsigned long error_code);
void
do_segment_not_present(unsigned long rsp, unsigned long error_code)
{
...
void
do_stack_segment_fault(unsigned long rsp, unsigned long error_code);
void
do_stack_segment_fault(unsigned long rsp, unsigned long error_code)
{
...
void
do_general_protection(unsigned long rsp, unsigned long error_code);
void
do_general_protection(unsigned long rsp, unsigned long error_code)
{
...
void
do_page_fault(unsigned long rsp, unsigned long error_code);
void
do_page_fault(unsigned long rsp, unsigned long error_code)
{
  unsigned long* p = NULL;
...
void
do_x87_FPU_error(unsigned long rsp, unsigned long error_code);
void
do_x87_FPU_error(unsigned long rsp, unsigned long error_code)
{
...
void
do_alignment_check(unsigned long rsp, unsigned long error_code);
void
do_alignment_check(unsigned long rsp, unsigned long error_code)
{
...
void
do_machine_check(unsigned long rsp, unsigned long error_code);
void
do_machine_check(unsigned long rsp, unsigned long error_code)
{
...
void
do_SIMD_exception(unsigned long rsp, unsigned long error_code);
void
do_SIMD_exception(unsigned long rsp, unsigned long error_code)
{
...
void
do_virtualization_exception(unsigned long rsp, unsigned long error_code);
void
do_virtualization_exception(unsigned long rsp, unsigned long error_code)
{
